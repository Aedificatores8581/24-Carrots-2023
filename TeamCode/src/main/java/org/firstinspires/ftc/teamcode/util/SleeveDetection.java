...
public class SleeveDetection extends OpenCvPipeline {
    ...
    private static Point SLEEVE_TOPLEFT_ANCHOR_POINT = new Point(95, 148);
    ...
    private static final Scalar
            ...
            lower_magenta_bounds = new Scalar(100, 20, 100, 255),
            upper_magenta_bounds = new Scalar(255, 140, 255, 255);
